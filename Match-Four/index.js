...
$('.board button').on('click',function() {
  ...
  if (currentPlayer === 1) {
    currentName = player1;
    $('h3').text("Hey "+currentName+": It is your turn, please pick a column to drop your Red chip.");
    currentColor = player1Color;
  }else {
    currentName = player2
    $('h3').text("Hey "+currentName+": It is your turn, please pick a column to drop your Yellow chip.");
